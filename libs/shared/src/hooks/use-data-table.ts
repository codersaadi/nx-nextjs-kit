...
import { useQueryString } from '@org/shared/hooks/use-update-query-params';
...
interface UseDataTableProps<TData>
  ...
  // Use ZodSchema type for searchParamsSchema
  searchParamsSchema: Required<ZodSchema>;
